...
import com.daqi.baseproject.utils.U_CommonUtils;
...
public class B_BaseActivity extends AppCompatActivity{
    ...
    public void finish() {
        super.finish();
        B_IApplication.removeActivity(this);
        overridePendingTransition(R.anim.b_push_left_in, R.anim.b_push_left_out);
    }
    ...
    protected void initTitle(boolean isShowBack, String title, boolean isShowRight) {
        ...
        if (null != tvTitle && U_CommonUtils.isnotNull(title)) {
